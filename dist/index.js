                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    response.status(wordObject_1 ? 200 : 404).contentType('text/html').send("<html>\n  <head>\n    <meta charset=\"utf-8\" />\n      <title>The Santinian Dictionary of Modern Language</title>\n      <style>body{font-family:system-ui;}@media(prefers-color-scheme:dark){body{background-color:black;color:white;}}</style>\n\n      <link rel=\"icon\" type=\"image/x-icon\" href=\"".concat(favicon_1.FAVICON_DATASOURCE, "\" />\n  </head>\n  <body>\n    <h1>The Santinian Dictionary of Modern Language</h1>\n\n    ").concat(wordObject_1 ? "<ol>\n      ".concat(wordObject_1.definitions.map(function (definition) { return "<li><strong>".concat(word, " (").concat(definition.shortenedWordType, ")</strong> /").concat(definition.ipa, "/ <br /> ").concat(wordObject_1.from ? "<div class=\"wrapper\" style=\"width:40pc;\"><p style=\"color:green;\">".concat(wordObject_1.from, "</p></div>") : '', "<p>").concat(definition.text, "</p> ").concat(definition.example ? "<p><strong>Example:</strong> ".concat(definition.example, "</p>") : '', "</li>"); }).join('\n'), "\n  \n    </ol>") : "<p style=\"color: orange;\">No definitions found for \"".concat(word, "\"</p>"), "\n  </body>\n</html>"));
                                    _a.label = 3;
